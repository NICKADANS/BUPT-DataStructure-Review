...
11. 
    ...
    **思路:**先序遍历二叉树，当遇到值为x的结点时，删除它的所有孩子。（答案好像好复杂？）s
...
13. 
    ...
    **代码:**
    ...
    TreeNode *Ancestor(TreeNode *root, TreeNode *p, TreeNode *q, TreeNode *r){
...
19. 
    ...
    **思路:**非递归方式遍历，用栈存储路径，用一个变量存储总权值，一个变量存储当前路径的深度，每次遇到叶节点，计算权值并加到总权值里。

    注意，二叉树的带权路径长度是每个叶子结点的深度和其权值之积的总和。
